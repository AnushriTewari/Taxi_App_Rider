...
import { removeCard } from '../../../actions/payment/riderCardPayment';
import { updateCardDetails } from '../../../actions/payment/riderCardPayment';
  ...
  render() {
    return (
      <Container>
        ...
        {this.props.cardDetails.length > 0 ? this.showCards() : this.noCards()}
      </Container>
    );
  }
}
