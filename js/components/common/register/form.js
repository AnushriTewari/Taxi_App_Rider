...
const validate = values => {
  ...
  //  else if (!values.phoneNo.match(/^[4|04]*$/)) {
  //   errors.phoneNo = "Enter a mobile number";
  // } 
  else if (!values.password) {
    errors.password = "Password is Required";
  } else if (values.password !== values.confirmPassword) {
    errors.confirmPassword = "Entered passwords don’t match";
  }
  return errors;
};
    ...
    return (
      <View>
        ...
        >
          ...
          <Field
            component={input}
            // onUpdate={(value)=>console.log('dataa------------aaaa',value)}
            name="phoneNo"
        ...
        <View style={styles.regBtnContain}>
          <Button
            ...
            // onPress={()=>Actions.otpverification({values:this.state.mobile})}
            block
            style={styles.regBtn}
          >
